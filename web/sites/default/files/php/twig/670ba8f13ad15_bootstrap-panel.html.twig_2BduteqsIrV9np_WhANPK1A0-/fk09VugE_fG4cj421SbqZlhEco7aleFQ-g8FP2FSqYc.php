...
class __TwigTemplate_36a33ce236af87eb0a3cbf9f4af4dfc9 extends Template
{
    private $source;
    private $macros = [];
...
($context["description"] ?? null) && (twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "position", [], "any", false, false, true, 85) == "invisible"))) ? ("sr-only") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/bootstrap/bootstrap-panel.html.twig", "/var/www/web/themes/contrib/bootstrap/templates/bootstrap/bootstrap-panel.html.twig");
    }
